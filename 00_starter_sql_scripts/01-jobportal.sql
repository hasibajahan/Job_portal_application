...
CREATE DATABASE `jobportal` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `jobportal`.`users_type`
...
CONSTRAINT `FKohp1poe14x1w56yxbwu2tpdm7` FOREIGN KEY (`user_account_id`) REFERENCES `users` (`user_id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
KEY `FK62yqqbypsq2ik34ngt1w4m9k3` (`posted_by_id`),
CONSTRAINT `FK44003mnvj29aiijhsc6ftsgxe` FOREIGN KEY (`job_location_id`) REFERENCES `job_location` (`id`),
CONSTRAINT `FK62yqqbypsq2ik34ngt1w4m9k3` FOREIGN KEY (`posted_by_id`) REFERENCES `users` (`user_id`),
...
PRIMARY KEY (`id`),
UNIQUE KEY `UKIvn1w4dxfiavb5q2gu1nwhxo` (`user_id`, `job`),
KEY `FKpb44x040gkdltxqy9m7jmvvf3` (`job`),
CONSTRAINT `FK96dyvgd8hmdohqsfdpvy189mg` FOREIGN KEY (`user_id`) REFERENCES `job_seeker_profile` (`user_account_id`),
...
KEY `FKmfhx9q4uc1bb74vm491v9dmf4` (`job`),
CONSTRAINT `FKmfhx9q4uc1bb74vm491v9dmf4` FOREIGN KEY (`job`) REFERENCES `job_post_activity` (`job_post_id`),
